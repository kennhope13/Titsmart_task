...
const targetContent = `<div className="grid grid-cols-1 gap-6 xl:grid-cols-2">
...
f = f.replace(targetContent, replacementContent);

// And we need to fix formatTimeOnly to include date!
