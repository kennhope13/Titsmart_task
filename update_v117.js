const fs = require("fs");
const newVersion = "1.0.117";
const date = "22/08/2026";
const notes = [
  "Tối ưu hiển thị và chỉnh sửa trường Ghi chú: ẩn các thẻ siêu dữ liệu hệ thống (Import từ phụ lục, [section], [order]...) để khung chỉnh sửa trống và gọn gàng hơn cho người dùng."
];
