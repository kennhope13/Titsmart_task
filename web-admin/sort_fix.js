const fs = require('fs');
const filepath = 'src/pages/ActivityLogPage.tsx';
...
if (!content.includes('getTimestampMs(b.timestamp || \'\')')) {
  // Use a targeted replace to avoid matching anything else
  const target = "return matchDate && matchSearch;\\r?\\n\\s*\\}\\);";
  const replacement = "return matchDate && matchSearch;\\n      }).sort((a, b) => getTimestampMs(b.timestamp || '') - getTimestampMs(a.timestamp || ''));";
