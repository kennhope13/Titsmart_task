...
export const Toast: React.FC<ToastProps> = ({ show, message, type = 'success' }) => {
  ...
  return (
    <div
      className={`fixed bottom-2 left-1/2 -translate-x-1/2 z-[9999] flex items-center gap-3 bg-inverse-surface text-inverse-on-surface px-4 py-3 rounded-lg shadow-xl transition-all duration-300 opacity-100 border border-outline-variant/30`}
    >
