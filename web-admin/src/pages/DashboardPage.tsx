...
export const DashboardPage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col flex-1 h-full bg-slate-100 overflow-hidden text-slate-800">
      {/* HEADER SECTION */}
      <section className={`sticky top-0 z-10 border-b border-slate-200 bg-white shadow-sm px-3 py-4 md:py-0 md:h-12 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 shrink-0 ${window.electronAPI ? 'pr-[180px]' : 'pr-4'}`}>
