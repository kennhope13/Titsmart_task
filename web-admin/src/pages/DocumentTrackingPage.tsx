...
export const DocumentTrackingPage: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* HEADER SECTION */}
      <section className="border-b border-slate-200 bg-white shadow-sm px-6 pr-[140px] py-5 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
