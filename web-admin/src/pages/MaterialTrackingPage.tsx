...
export const MaterialTrackingPage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col flex-1 h-full bg-slate-50 relative overflow-hidden">
      <section className="border-b border-slate-200 bg-white pl-6 pr-[140px] py-4 md:py-0 md:h-[72px] flex flex-col xl:flex-row justify-between xl:items-center gap-3">
