...
export const MaterialTrackingPage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col flex-1 h-full bg-slate-50 relative overflow-hidden">
      <section className="border-b border-slate-200 bg-white pl-6 pr-[140px] py-4 md:py-0 md:h-12 flex flex-col xl:flex-row justify-between xl:items-center gap-3">
        <div className="flex items-center gap-4">
          <div>
            <div className="flex items-center gap-3 border-l-4 border-primary pl-4">
              <h2 className="text-lg font-extrabold text-slate-900">QUẢN LÝ KHO & VẬT TƯ</h2>
            </div>
          </div>
        </div>
