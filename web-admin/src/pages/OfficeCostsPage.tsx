...
export const OfficeCostsPage: React.FC = () => {
  ...
  return (
    <div className="flex-1 flex flex-col min-w-0 min-h-0 bg-slate-50 overflow-hidden relative">
      <div className="px-5 py-4 flex flex-col gap-1 border-b border-slate-200 bg-white shrink-0 shadow-sm z-10">
        <div className="flex items-center gap-2 text-slate-500 text-xs font-semibold tracking-wide">
          <span className="material-symbols-outlined text-[14px]">account_balance_wallet</span>
          <span>KẾ TOÁN</span>
          <span className="material-symbols-outlined text-[14px]">chevron_right</span>
          <span className="text-primary">CHI PHÍ VĂN PHÒNG</span>
        </div>
        <div className="flex items-center justify-between">
          <h1 className="text-xl font-black text-slate-900 uppercase font-['Inter'] tracking-tight">Chi Phí Văn Phòng</h1>
