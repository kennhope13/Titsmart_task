...
// Cleaned debug log
    ...
    if ((activeTab === 'TECH' || activeTab === 'DOCS' || activeTab === 'FINANCE')) {
      data = currentProjMaterialPlans.map(p => {
        ...
        return {
          ...
          "Đơn giá bán": pRecord?.unitPrice || 0,
          "VAT %": pRecord?.vatRate || 0,
          "Tiền VAT": pRecord?.vatAmount || 0,
          "Thành tiền bán": pRecord?.totalAmount || 0,
          ...
          "Chi phí (Giá vốn)": pRecord?.prepayAmount || 0,
  ...
  return (
    <div className="flex flex-col flex-1 overflow-y-auto">
      ...
      {/* HEADER SECTION */}
      {!projectId && (
        <section className="sticky top-0 z-10 border-b border-slate-200 bg-white shadow-sm pl-3 pr-16 md:pr-20 py-4 md:py-0 md:h-12 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
