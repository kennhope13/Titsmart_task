        ...
        {activeTab === 'EXPENSE' && (
          <div className="h-full overflow-y-auto overflow-x-hidden custom-scrollbar bg-white flex flex-col" id="expense-unified-view">
            ...
            <div className="bg-white border-t border-slate-200 overflow-hidden flex-1 flex flex-col">
              <div className="flex border-b border-slate-100 bg-slate-50 px-5 py-2 gap-3 sticky top-0 z-20 items-center justify-between text-xs text-slate-600 flex-wrap">
                  {/* Search Bar */}
                  <div className="relative w-[280px] shrink-0">
                    ...
                    <input
                      type="text"
                      placeholder="Tìm kiếm nội dung, diễn giải, người nhận..."
                      value={searchQuery}
                      onChange={(e) => setSearchQuery(e.target.value)}
                      className="w-full pl-9 pr-3 py-1.5 border border-slate-200 rounded-md text-xs focus:ring-1 focus:ring-primary focus:border-primary outline-none bg-white shadow-sm transition-all"
                    />
                  </div>
