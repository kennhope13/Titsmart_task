...
export const ProjectDetailPage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden bg-slate-100">
      {/* Top Project Bar */}
      <div className={`bg-white border-b border-slate-200 pl-5 py-2.5 flex flex-col sm:flex-row sm:items-center justify-between gap-2 flex-shrink-0 shadow-sm electron-drag ${window.electronAPI ? 'pr-[140px]' : 'pr-5'}`}>
