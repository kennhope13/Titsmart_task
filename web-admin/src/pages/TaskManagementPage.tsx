      ...
      <div className="px-5 py-2 flex flex-col lg:flex-row justify-between lg:items-center gap-4 border-b border-slate-100">
        <div className="flex min-w-0 flex-1 items-center gap-3">
          ...
          <div className="min-w-0 flex-1 flex items-center gap-3">
            <h2 className="page-title text-lg font-extrabold text-slate-900 border-l-4 border-primary pl-4 uppercase whitespace-nowrap flex-shrink-0">QUẢN LÝ TIẾN ĐỘ CÔNG VIỆC</h2>
            {selectedProjectFromUrl && (
