...
const data = fs.readFileSync('../documents/2.PL01 Bảng giá HĐ SCADA và TTLL - TBA 110kV Phước Tân (TSM_HGP).xlsx');
...
console.log('Total parsed for Phước Tân:', pendingTasks.length);
console.log('STTs:', pendingTasks.map(t => t.stt).join(', '));
